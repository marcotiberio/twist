...
function registerArticlePostType()
{
    $labels = [
        'name'                  => _x('Articles', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Article', 'Post Type Singular Name', 'flynt'),
...
add_action('init', '\\Flynt\\CustomPostTypes\\registerArticlePostType');
